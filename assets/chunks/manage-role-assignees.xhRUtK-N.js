import{p as J}from"./context.o83FBgiQ.js";import{H as ce,i as g,x as d,r as M,f as V,T as nt,E as Ct,g as Rt,S as he,p as pe,l as Kt,m as Wt,j as me,t as At,k as Vt,u as wt,n as fe}from"./roles-client.DcXMkolf.js";import{S as K}from"./signal-watcher.DfgS61mm.js";import{_ as h}from"./tslib.es6.kHcLnhpD.js";import{w as lt,b as jt,d as be,e as A,S as gt,_ as n,r as T,f as E,g as z,i as F,j as w,m,h as W,k as Tt,l as zt,t as O,s as j,c as Y,n as ge,o as Yt,p as Xt,q as X,L as dt,u as mt,v as G,x as U,y as q,z as f,A as Gt,B as Qt,C as Pt,D as ve,E as Zt,F as ye,G as Ot,a as ct}from"./role-config.HuCNaWQK.js";import{n as r,t as B}from"./property.D124yKuw.js";import{r as _e}from"./context.DEBmPvHP.js";function we(t,e){{const s=t.find(i=>i&&i.status==="error");if(s)return s}{const s=t.find(i=>i&&i.status==="pending");if(s)return s}return{status:"completed",value:t.filter(s=>s.status==="completed").map(s=>s.value)}}function Jt(t,e){const o=Array.from(t.entries()).map(([a,l])=>l.status!=="completed"?l:{status:"completed",value:[a,l.value]}),s=we(o);return s.status!=="completed"?s:{status:"completed",value:new ce(s.value)}}/**
 * @license
 ...
 */const tt=()=>(t,e)=>(t.addInitializer($e),t);class te{constructor(e){this.host=e,this.host.addController(this),this.handleFormData=this.handleFormData.bind(this),this.handleFormSubmit=this.handleFormSubmit.bind(this),this.handleFormReset=this.handleFormReset.bind(this)}closestElement(e){function o(s){if(!s||s===document||s===window)return null;s.assignedSlot&&(s=s.assignedSlot);const i=s.closest(e);return i||o(s.getRootNode().host)}return o(this.host)}hostConnected(){this.form=this.closestElement("form"),this.form&&(this.form.addEventListener("formdata",this.handleFormData),this.form.addEventListener("submit",this.handleFormSubmit),this.form.addEventListener("reset",this.handleFormReset),this.form.dispatchEvent(new CustomEvent("update-form")))}hostDisconnected(){this.form&&(this.form.removeEventListener("formdata",this.handleFormData),this.form.removeEventListener("submit",this.handleFormSubmit),this.form.removeEventListener("reset",this.handleFormReset),this.form=void 0)}handleFormData(e){const o=this.host.disabled,s=this.host.name,i=this.host.value;!o&&s&&i!==void 0&&(Array.isArray(i)?i.map(a=>e.formData.append(s,a)):e.formData.append(s,i))}handleFormSubmit(e){const o=this.form,s=this.host.disabled,i=this.host.reportValidity;o&&!o.noValidate&&!s&&i&&!this.host.reportValidity()&&(e.preventDefault(),e.stopImmediatePropagation())}handleFormReset(e){this.host.reset()}}function Ce(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}function Ee(t,e="primary",o=jt,s=3e3){const i=Object.assign(document.createElement("sl-alert"),{variant:e,closable:!0,duration:s,innerHTML:`
        ...
        ${Ce(t)}
      `});return document.body.append(i),i.toast()}function Bt(t){return Ee(t,"danger",be)}var Se=g`
  :host {
...
`,P=class extends z{constructor(){super(...arguments),this.hasError=!1,this.image="",this.label="",this.initials="",this.loading="eager",this.shape="circle"}handleImageChange(){this.hasError=!1}handleImageLoadError(){this.hasError=!0,this.emit("sl-error")}render(){const t=d`
      <img
        part="image"
        class="avatar__image"
        src="${this.image}"
    ...
    `}};P.styles=[A,Se];P.dependencies={"sl-icon":gt};n([T()],P.prototype,"hasError",2);n([r()],P.prototype,"image",2);n([r()],P.prototype,"label",2);n([r()],P.prototype,"initials",2);n([r()],P.prototype,"loading",2);n([r({reflect:!0})],P.prototype,"shape",2);n([E("image")],P.prototype,"handleImageChange",1);P.define("sl-avatar");var Ae=g`
  :host {
...
`,Lt=class extends z{constructor(){super(...arguments),this.effect="none"}render(){return d`
      <div
        part="base"
    ...
    `}};Lt.styles=[A,Ae];n([r()],Lt.prototype,"effect",2);Lt.define("sl-skeleton");let ft=[0],pt=0;function Te(t){t[0]===132&&t[1]===32&&t[2]===36?ft=t.slice(3):ft=t||[],pt=0}function _(){return(()=>{const e=ft[pt];return pt=(pt+1)%ft.length,e})()/256}function ee(t){const e=Math.floor(_()*360),o=_()*60+40,s=t||(_()*100+(_()+_()+_()+_())*25)/2;return{h:e,s:o,l:s}}function oe({h:t,s:e,l:o}){return`hsl(${t}, ${e}%, ${o}%)`}function ze(t,e,o){const s=_()*2*Math.PI,i=e*Math.cos(s),a=e*Math.sin(s),l=o.x+i,u=o.x+a,b=s+2*Math.PI*.3,v=e*Math.cos(b),H=e*Math.sin(b),C=o.x+v,ut=o.x+H,N=b+2*Math.PI*.3,ae=e*Math.cos(N),le=e*Math.sin(N),de=o.x+ae,ue=o.x+le;t.beginPath(),t.moveTo(l,u),t.lineTo(C,ut),t.lineTo(de,ue),t.fill()}function Pe(t){const e=t.hash||[0];return Te(e),{backgroundColor:t.backgroundColor||oe(ee()),hash:e,size:t.size||32}}function Le(t,e){if(t.hash&&!(t.hash instanceof Uint8Array))throw new Error("invalid type for opts.hash, expecting Uint8Array or null");t=Pe(t||{});const{size:o,backgroundColor:s}=t;e.width=e.height=o;const i=e.getContext("2d");if(!i)return;i.fillStyle=s,i.fillRect(0,0,e.width,e.height);const a=_()<.5?3:4,l=Array.apply(null,Array(a)).map((u,b)=>{const v=b===0?5+_()*25:b===1?70+_()*25:null;return{x:_()*o,y:_()*o,radius:5+_()*o*.25,type:Math.floor(_()*3),color:oe(ee(v))}}).sort((u,b)=>u.radius>b.radius?-1:1);for(let u=0;u<a;u++){const b=l[u],{x:v,y:H,radius:C,type:ut,color:N}=b;switch(i.fillStyle=N,ut){case 0:i.beginPath(),i.arc(v,H,C,0,2*Math.PI),i.fill();break;case 1:i.fillRect(v,H,C*2,C*2);break;case 2:ze(i,C*2,{x:v,y:H});break;default:throw new Error("shape is greater than 2, this should never happen")}}return e}var R=function(t,e,o,s){var i=arguments.length,a=i<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,o):s,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,e,o,s);else for(var u=t.length-1;u>=0;u--)(l=t[u])&&(a=(i<3?l(a):i>3?l(e,o,a):l(e,o))||a);return i>3&&a&&Object.defineProperty(e,o,a),a};let S=class extends M{constructor(){super(...arguments),this.size=32,this.shape="circle",this.disableTooltip=!1,this.disableCopy=!1,this.justCopiedHash=!1}async copyHash(){this.disableCopy||(await navigator.clipboard.writeText(this.strHash),this.timeout&&clearTimeout(this.timeout),this.justCopiedHash=!0,this._tooltip.show(),this.timeout=setTimeout(()=>{this._tooltip.hide(),setTimeout(()=>{this.justCopiedHash=!1},100)},2e3))}get strHash(){return V(this.hash)}updated(e){var o,s;super.updated(e),(e.has("hash")&&((o=e.get("hash"))==null?void 0:o.toString())!==((s=this.hash)==null?void 0:s.toString())||e.has("size")||e.has("value"))&&Le({hash:this.hash,size:this.size},this._canvas)}renderCanvas(){return d` <canvas
      id="canvas"
      width="1"
      height="1"
 ...
 */const se="important",Fe=" !"+se,xt=Tt(class extends zt{constructor(t){var e;if(super(t),t.type!==O.ATTRIBUTE||t.name!=="style"||((e=t.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,o)=>{const s=t[o];return s==null?e:e+`${o=o.includes("-")?o:o.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(t,[e]){const{style:o}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const s of this.ft)e[s]==null&&(this.ft.delete(s),s.includes("-")?o.removeProperty(s):o[s]=null);for(const s in e){const i=e[s];if(i!=null){this.ft.add(s);const a=typeof i=="string"&&i.endsWith(Fe);s.includes("-")||a?o.setProperty(s,a?i.slice(0,-11):i,a?se:""):o[s]=i}}return nt}});let I=class extends K(M){constructor(){super(...arguments),this.size=32,this.disableTooltip=!1,this.disableCopy=!1}renderIdenticon(){return this.agentPubKey?d` <div
		...
		`}profile(){if(this.profileHash)return this.store.profiles.get(this.profileHash).latestVersion.get();if(this.agentPubKey){const e=this.store.profileForAgent.get(this.agentPubKey).get();return e.status!=="completed"?e:e.value===void 0?{status:"completed",value:void 0}:e.value.latestVersion.get()}else throw new Error("Either agentPubKey or profileHash needs to be defined for the agent-avatar element")}render(){if(this.store.config.avatarMode==="identicon")return this.renderIdenticon();const e=this.profile();switch(e.status){case"pending":return d`<sl-skeleton
					effect="pulse"
      ...
      `]}};Ht=h([B("profile-list-item-skeleton")],Ht);let Q=class extends K(M){profile(){if(this.profileHash)return this.store.profiles.get(this.profileHash).latestVersion.get();if(this.agentPubKey){const e=this.store.profileForAgent.get(this.agentPubKey).get();return e.status!=="completed"?e:e.value===void 0?{status:"completed",value:void 0}:e.value.latestVersion.get()}else throw new Error("Either agentPubKey or profileHash needs to be defined for the agent-avatar element")}render(){var e;const o=this.profile();switch(o.status){case"pending":return d`<profile-list-item-skeleton></profile-list-item-skeleton>`;case"completed":return d`
...
`,Ft=class extends z{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(t){const e=["menuitem","menuitemcheckbox"],o=t.composedPath(),s=o.find(u=>{var b;return e.includes(((b=u==null?void 0:u.getAttribute)==null?void 0:b.call(u,"role"))||"")});if(!s||o.find(u=>{var b;return((b=u==null?void 0:u.getAttribute)==null?void 0:b.call(u,"role"))==="menu"})!==this)return;const l=s;l.type==="checkbox"&&(l.checked=!l.checked),this.emit("sl-select",{detail:{item:l}})}handleKeyDown(t){if(t.key==="Enter"||t.key===" "){const e=this.getCurrentItem();t.preventDefault(),t.stopPropagation(),e==null||e.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(t.key)){const e=this.getAllItems(),o=this.getCurrentItem();let s=o?e.indexOf(o):0;e.length>0&&(t.preventDefault(),t.stopPropagation(),t.key==="ArrowDown"?s++:t.key==="ArrowUp"?s--:t.key==="Home"?s=0:t.key==="End"&&(s=e.length-1),s<0&&(s=e.length-1),s>e.length-1&&(s=0),this.setCurrentItem(e[s]),e[s].focus())}}handleMouseDown(t){const e=t.target;this.isMenuItem(e)&&this.setCurrentItem(e)}handleSlotChange(){const t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0])}isMenuItem(t){var e;return t.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((e=t.getAttribute("role"))!=null?e:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(o=>{o.setAttribute("tabindex",o===t?"0":"-1")})}render(){return d`
      ...
      ></slot>
    `}};Ft.styles=[A,Qe];n([w("slot")],Ft.prototype,"defaultSlot",2);Ft.define("sl-menu");var Ze=g`
  :host {
    display: block;
  }
...
`,_t=class extends z{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};_t.styles=[A,lo];n([r({type:Boolean,reflect:!0})],_t.prototype,"vertical",2);n([E("vertical")],_t.prototype,"handleVerticalChange",1);_t.define("sl-divider");vt.define("sl-spinner");var uo=Object.defineProperty,co=Object.getOwnPropertyDescriptor,et=(t,e,o,s)=>{for(var i=s>1?void 0:s?co(e,o):e,a=t.length-1,l;a>=0;a--)(l=t[a])&&(i=(s?l(e,o,i):l(i))||i);return s&&i&&uo(e,o,i),i};let D=class extends K(M){constructor(){super(...arguments),this.committing=!1,this.removingRole=!1}async addMembersToRole(t,e){try{this.committing=!0;const s=(await Promise.all(e.map(i=>At(this.profilesStore.agentsForProfile.get(i))))).map(i=>i[0]);await this.store.client.assignRole(t,s),this.dispatchEvent(new CustomEvent("role-assigned-to-members",{composed:!0,bubbles:!0,detail:{role:t,assigneesProfilesHashes:e,assignees:s}})),this.shadowRoot.getElementById(`add-members-${t}`).hide()}catch(o){console.error(o),Bt(m("Error adding members to the role"))}this.committing=!1}async removeRole(t,e,o){try{this.removingRole=!0,await this.store.client.requestUnassignRole(t,o),this.dispatchEvent(new CustomEvent("unassig-role-requested",{composed:!0,bubbles:!0,detail:{role:t,assignee:e}})),this.shadowRoot.getElementById(`remove-role-${t}-for-${V(e)}`).hide()}catch(s){console.error(s),Bt(m("Error removing the role"))}this.removingRole=!1}name(t){var o;const e=this.profilesStore.profiles.get(t).latestVersion.get();if(e.status==="completed")return(o=e.value)==null?void 0:o.entry.nickname}renderRemoveRoleAction(t,e,o,s){const i=this.store.pendingUnassignments.get();switch(i.status){case"pending":return d`<sl-skeleton></sl-skeleton>`;case"error":return d`<display-error
			...
			<div class="column" style="flex: 1">
			...
			</div>`}assigneesForRoleAndIAmAdmin(){const t=this.store.assigneesForRoleLinks.get(this.role).get(),e=this.store.myRoles.get();if(t.status!=="completed")return t;if(e.status!=="completed")return e;const o=Jt(Wt(Kt(this.profilesStore.profileForAgent,t.value.map(i=>i.target)),i=>{var l;const a=i.get();return a.status!=="completed"?a:{status:"completed",value:(l=a.value)==null?void 0:l.profileHash}}));if(o.status!=="completed")return o;const s=e.value.includes(ct.role);return{status:"completed",value:{assignees:t.value,iAmAdmin:s,profilesHashesForAgents:o.value}}}render(){const t=this.assigneesForRoleAndIAmAdmin();switch(t.status){case"pending":return d`<div
				...
				>
					...
					.error=${t.error}
				></display-error>`;case"completed":const e=this.role===ct.role?ct:this.store.config.roles_config.find(o=>o.role===this.role);return this.renderRole(e,t.value.assignees,t.value.iAmAdmin,t.value.profilesHashesForAgents)}}};D.styles=[j,g`
			sl-divider {
				--spacing: var(--sl-spacing-small);
			}
		`];et([r()],D.prototype,"role",2);et([Y({context:_e,subscribe:!0}),r()],D.prototype,"store",2);et([Y({context:J,subscribe:!0})],D.prototype,"profilesStore",2);et([T()],D.prototype,"committing",2);et([T()],D.prototype,"removingRole",2);D=et([B("manage-role-assignees")],D);const Eo=Object.freeze(Object.defineProperty({__proto__:null,get ManageRoleAssignees(){return D}},Symbol.toStringTag,{value:"Module"}));export{tt as l,Eo as m};
