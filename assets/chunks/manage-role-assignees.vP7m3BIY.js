...
`,P=class extends z{constructor(){super(...arguments),this.hasError=!1,this.image="",this.label="",this.initials="",this.loading="eager",this.shape="circle"}handleImageChange(){this.hasError=!1}handleImageLoadError(){this.hasError=!0,this.emit("sl-error")}render(){const t=l`
    ...
    `}};P.styles=[A,_e];P.dependencies={"sl-icon":yt};n([T()],P.prototype,"hasError",2);n([r()],P.prototype,"image",2);n([r()],P.prototype,"label",2);n([r()],P.prototype,"initials",2);n([r()],P.prototype,"loading",2);n([r({reflect:!0})],P.prototype,"shape",2);n([E("image")],P.prototype,"handleImageChange",1);P.define("sl-avatar");var we=g`
  :host {
...
`,It=class extends z{constructor(){super(...arguments),this.effect="none"}render(){return l`
    ...
    `}};It.styles=[A,we];n([r()],It.prototype,"effect",2);It.define("sl-skeleton");let gt=[0],ft=0;function xe(t){t[0]===132&&t[1]===32&&t[2]===36?gt=t.slice(3):gt=t||[],ft=0}function _(){return(()=>{const e=gt[ft];return ft=(ft+1)%gt.length,e})()/256}function Zt(t){const e=Math.floor(_()*360),o=_()*60+40,s=t||(_()*100+(_()+_()+_()+_())*25)/2;return{h:e,s:o,l:s}}function Jt({h:t,s:e,l:o}){return`hsl(${t}, ${e}%, ${o}%)`}function ke(t,e,o){const s=_()*2*Math.PI,i=e*Math.cos(s),a=e*Math.sin(s),u=o.x+i,d=o.x+a,b=s+2*Math.PI*.3,v=e*Math.cos(b),B=e*Math.sin(b),C=o.x+v,dt=o.x+B,U=b+2*Math.PI*.3,ie=e*Math.cos(U),re=e*Math.sin(U),ne=o.x+ie,ae=o.x+re;t.beginPath(),t.moveTo(u,d),t.lineTo(C,dt),t.lineTo(ne,ae),t.fill()}function $e(t){const e=t.hash||[0];return xe(e),{backgroundColor:t.backgroundColor||Jt(Zt()),hash:e,size:t.size||32}}function Ce(t,e){if(t.hash&&!(t.hash instanceof Uint8Array))throw new Error("invalid type for opts.hash, expecting Uint8Array or null");t=$e(t||{});const{size:o,backgroundColor:s}=t;e.width=e.height=o;const i=e.getContext("2d");if(!i)return;i.fillStyle=s,i.fillRect(0,0,e.width,e.height);const a=_()<.5?3:4,u=Array.apply(null,Array(a)).map((d,b)=>{const v=b===0?5+_()*25:b===1?70+_()*25:null;return{x:_()*o,y:_()*o,radius:5+_()*o*.25,type:Math.floor(_()*3),color:Jt(Zt(v))}}).sort((d,b)=>d.radius>b.radius?-1:1);for(let d=0;d<a;d++){const b=u[d],{x:v,y:B,radius:C,type:dt,color:U}=b;switch(i.fillStyle=U,dt){case 0:i.beginPath(),i.arc(v,B,C,0,2*Math.PI),i.fill();break;case 1:i.fillRect(v,B,C*2,C*2);break;case 2:ke(i,C*2,{x:v,y:B});break;default:throw new Error("shape is greater than 2, this should never happen")}}return e}var D=function(t,e,o,s){var i=arguments.length,a=i<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,o):s,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,e,o,s);else for(var d=t.length-1;d>=0;d--)(u=t[d])&&(a=(i<3?u(a):i>3?u(e,o,a):u(e,o))||a);return i>3&&a&&Object.defineProperty(e,o,a),a};let S=class extends M{constructor(){super(...arguments),this.size=32,this.shape="circle",this.disableTooltip=!1,this.disableCopy=!1,this.justCopiedHash=!1}async copyHash(){this.disableCopy||(await navigator.clipboard.writeText(this.strHash),this.timeout&&clearTimeout(this.timeout),this.justCopiedHash=!0,this._tooltip.show(),this.timeout=setTimeout(()=>{this._tooltip.hide(),setTimeout(()=>{this.justCopiedHash=!1},100)},2e3))}get strHash(){return N(this.hash)}updated(e){var o,s;super.updated(e),(e.has("hash")&&((o=e.get("hash"))==null?void 0:o.toString())!==((s=this.hash)==null?void 0:s.toString())||e.has("size")||e.has("value"))&&Ce({hash:this.hash,size:this.size},this._canvas)}renderCanvas(){return l` <canvas
      id="canvas"
      width="1"
      height="1"
    ...
    `}};D([r(ut("hash"))],S.prototype,"hash",void 0);D([r({type:Number})],S.prototype,"size",void 0);D([r({type:String})],S.prototype,"shape",void 0);D([r({type:Boolean,attribute:"disable-tooltip"})],S.prototype,"disableTooltip",void 0);D([r({type:Boolean,attribute:"disable-copy"})],S.prototype,"disableCopy",void 0);D([w("#canvas")],S.prototype,"_canvas",void 0);D([w("#tooltip")],S.prototype,"_tooltip",void 0);D([T()],S.prototype,"justCopiedHash",void 0);S=D([j(),O("holo-identicon")],S);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const te="important",Ee=" !"+te,$t=zt(class extends Pt{constructor(t){var e;if(super(t),t.type!==L.ATTRIBUTE||t.name!=="style"||((e=t.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,o)=>{const s=t[o];return s==null?e:e+`${o=o.includes("-")?o:o.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(t,[e]){const{style:o}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const s of this.ft)e[s]==null&&(this.ft.delete(s),s.includes("-")?o.removeProperty(s):o[s]=null);for(const s in e){const i=e[s];if(i!=null){this.ft.add(s);const a=typeof i=="string"&&i.endsWith(Ee);s.includes("-")||a?o.setProperty(s,a?i.slice(0,-11):i,a?te:""):o[s]=i}}return rt}});let R=class extends G(M){constructor(){super(...arguments),this.size=32,this.disableTooltip=!1,this.disableCopy=!1}renderIdenticon(){return this.agentPubKey?l` <div
		...
		`];h([r(ut("agent-pub-key"))],R.prototype,"agentPubKey",void 0);h([r({type:Number})],R.prototype,"size",void 0);h([r({type:Boolean,attribute:"disable-tooltip"})],R.prototype,"disableTooltip",void 0);h([r({type:Boolean,attribute:"disable-copy"})],R.prototype,"disableCopy",void 0);h([W({context:J,subscribe:!0}),r()],R.prototype,"profilesProvider",void 0);R=h([j(),O("agent-avatar")],R);let Ut=class extends G(M){render(){return l`<div class="row" style="align-items: center; width: 150px">
      <sl-skeleton
        effect="sheen"
      ...
      `]}};Ut=h([O("profile-list-item-skeleton")],Ut);let lt=class extends G(M){render(){var e;const o=this.profilesProvider.currentProfileForAgent.get(this.agentPubKey).get();switch(o.status){case"pending":return l`<profile-list-item-skeleton></profile-list-item-skeleton>`;case"completed":return l`
					<div class="row" style="align-items: center; gap: 8px">
						<agent-avatar .agentPubKey=${this.agentPubKey}></agent-avatar>
						<span>${(e=o.value)===null||e===void 0?void 0:e.name}</span>
					</div>
				`;case"error":return l`<display-error
					tooltip
					.headline=${m("Error fetching the profile.")}
					.error=${o.error}
				></display-error>`}}};lt.styles=[K];h([r(ut("agent-pub-key"))],lt.prototype,"agentPubKey",void 0);h([W({context:J,subscribe:!0}),r()],lt.prototype,"profilesProvider",void 0);lt=h([j(),O("profile-list-item")],lt);Wt.define("sl-icon-button");var Se=g`
  :host {
    display: inline-block;
  }
...
`,Nt=new WeakMap;function ee(t){let e=Nt.get(t);return e||(e=window.getComputedStyle(t,null),Nt.set(t,e)),e}function Ae(t){if(typeof t.checkVisibility=="function")return t.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=ee(t);return e.visibility!=="hidden"&&e.display!=="none"}function Te(t){const e=ee(t),{overflowY:o,overflowX:s}=e;return o==="scroll"||s==="scroll"?!0:o!=="auto"||s!=="auto"?!1:t.scrollHeight>t.clientHeight&&o==="auto"||t.scrollWidth>t.clientWidth&&s==="auto"}function ze(t){const e=t.tagName.toLowerCase(),o=Number(t.getAttribute("tabindex"));return t.hasAttribute("tabindex")&&(isNaN(o)||o<=-1)||t.hasAttribute("disabled")||t.closest("[inert]")||e==="input"&&t.getAttribute("type")==="radio"&&!t.hasAttribute("checked")||!Ae(t)?!1:(e==="audio"||e==="video")&&t.hasAttribute("controls")||t.hasAttribute("tabindex")||t.hasAttribute("contenteditable")&&t.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:Te(t)}function Pe(t){var e,o;const s=At(t),i=(e=s[0])!=null?e:null,a=(o=s[s.length-1])!=null?o:null;return{start:i,end:a}}function Fe(t,e){var o;return((o=t.getRootNode({composed:!0}))==null?void 0:o.host)!==e}function At(t){const e=new WeakMap,o=[];function s(i){if(i instanceof Element){if(i.hasAttribute("inert")||i.closest("[inert]")||e.has(i))return;e.set(i,!0),!o.includes(i)&&ze(i)&&o.push(i),i instanceof HTMLSlotElement&&Fe(i,t)&&i.assignedElements({flatten:!0}).forEach(a=>{s(a)}),i.shadowRoot!==null&&i.shadowRoot.mode==="open"&&s(i.shadowRoot)}for(const a of i.children)s(a)}return s(t),o.sort((i,a)=>{const u=Number(i.getAttribute("tabindex"))||0;return(Number(a.getAttribute("tabindex"))||0)-u})}var y=class extends z{constructor(){super(...arguments),this.localize=new Z(this),this.open=!1,this.placement="bottom-start",this.disabled=!1,this.stayOpenOnSelect=!1,this.distance=0,this.skidding=0,this.hoist=!1,this.sync=void 0,this.handleKeyDown=t=>{this.open&&t.key==="Escape"&&(t.stopPropagation(),this.hide(),this.focusOnTrigger())},this.handleDocumentKeyDown=t=>{var e;if(t.key==="Escape"&&this.open&&!this.closeWatcher){t.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(t.key==="Tab"){if(this.open&&((e=document.activeElement)==null?void 0:e.tagName.toLowerCase())==="sl-menu-item"){t.preventDefault(),this.hide(),this.focusOnTrigger();return}setTimeout(()=>{var o,s,i;const a=((o=this.containingElement)==null?void 0:o.getRootNode())instanceof ShadowRoot?(i=(s=document.activeElement)==null?void 0:s.shadowRoot)==null?void 0:i.activeElement:document.activeElement;(!this.containingElement||(a==null?void 0:a.closest(this.containingElement.tagName.toLowerCase()))!==this.containingElement)&&this.hide()})}},this.handleDocumentMouseDown=t=>{const e=t.composedPath();this.containingElement&&!e.includes(this.containingElement)&&this.hide()},this.handlePanelSelect=t=>{const e=t.target;!this.stayOpenOnSelect&&e.tagName.toLowerCase()==="sl-menu"&&(this.hide(),this.focusOnTrigger())}}connectedCallback(){super.connectedCallback(),this.containingElement||(this.containingElement=this)}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){const t=this.trigger.assignedElements({flatten:!0})[0];typeof(t==null?void 0:t.focus)=="function"&&t.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(t=>t.tagName.toLowerCase()==="sl-menu")}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(t){if([" ","Enter"].includes(t.key)){t.preventDefault(),this.handleTriggerClick();return}const e=this.getMenu();if(e){const o=e.getAllItems(),s=o[0],i=o[o.length-1];["ArrowDown","ArrowUp","Home","End"].includes(t.key)&&(t.preventDefault(),this.open||(this.show(),await this.updateComplete),o.length>0&&this.updateComplete.then(()=>{(t.key==="ArrowDown"||t.key==="Home")&&(e.setCurrentItem(s),s.focus()),(t.key==="ArrowUp"||t.key==="End")&&(e.setCurrentItem(i),i.focus())}))}}handleTriggerKeyUp(t){t.key===" "&&t.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){const e=this.trigger.assignedElements({flatten:!0}).find(s=>Pe(s).start);let o;if(e){switch(e.tagName.toLowerCase()){case"sl-button":case"sl-icon-button":o=e.button;break;default:o=e}o.setAttribute("aria-haspopup","true"),o.setAttribute("aria-expanded",this.open?"true":"false")}}async show(){if(!this.open)return this.open=!0,bt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,bt(this,"sl-after-hide")}reposition(){this.popup.reposition()}addOpenListeners(){var t;this.panel.addEventListener("sl-select",this.handlePanelSelect),"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown)}removeOpenListeners(){var t;this.panel&&(this.panel.removeEventListener("sl-select",this.handlePanelSelect),this.panel.removeEventListener("keydown",this.handleKeyDown)),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),(t=this.closeWatcher)==null||t.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}if(this.updateAccessibleTrigger(),this.open){this.emit("sl-show"),this.addOpenListeners(),await X(this),this.panel.hidden=!1,this.popup.active=!0;const{keyframes:t,options:e}=q(this,"dropdown.show",{dir:this.localize.dir()});await H(this.popup.popup,t,e),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),await X(this);const{keyframes:t,options:e}=q(this,"dropdown.hide",{dir:this.localize.dir()});await H(this.popup.popup,t,e),this.panel.hidden=!0,this.popup.active=!1,this.emit("sl-after-hide")}}render(){return l`
      <sl-popup
        part="base"
 ...
 */const Oe=()=>new Me;class Me{}const Ct=new WeakMap,Be=zt(class extends Ve{render(t){return St}update(t,[e]){var s;const o=e!==this.Y;return o&&this.Y!==void 0&&this.rt(void 0),(o||this.lt!==this.ct)&&(this.Y=e,this.ht=(s=t.options)==null?void 0:s.host,this.rt(this.ct=t.element)),St}rt(t){if(this.isConnected||(t=void 0),typeof this.Y=="function"){const e=this.ht??globalThis;let o=Ct.get(e);o===void 0&&(o=new WeakMap,Ct.set(e,o)),o.get(this.Y)!==void 0&&this.Y.call(this.ht,void 0),o.set(this.Y,t),t!==void 0&&this.Y.call(this.ht,t)}else this.Y.value=t}get lt(){var t,e;return typeof this.Y=="function"?(t=Ct.get(this.ht??globalThis))==null?void 0:t.get(this.Y):(e=this.Y)==null?void 0:e.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});var Ue=class{constructor(t,e){this.popupRef=Oe(),this.enableSubmenuTimer=-1,this.isConnected=!1,this.isPopupConnected=!1,this.skidding=0,this.submenuOpenDelay=100,this.handleMouseMove=o=>{this.host.style.setProperty("--safe-triangle-cursor-x",`${o.clientX}px`),this.host.style.setProperty("--safe-triangle-cursor-y",`${o.clientY}px`)},this.handleMouseOver=()=>{this.hasSlotController.test("submenu")&&this.enableSubmenu()},this.handleKeyDown=o=>{switch(o.key){case"Escape":case"Tab":this.disableSubmenu();break;case"ArrowLeft":o.target!==this.host&&(o.preventDefault(),o.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case"ArrowRight":case"Enter":case" ":this.handleSubmenuEntry(o);break}},this.handleClick=o=>{var s;o.target===this.host?(o.preventDefault(),o.stopPropagation()):o.target instanceof Element&&(o.target.tagName==="sl-menu-item"||(s=o.target.role)!=null&&s.startsWith("menuitem"))&&this.disableSubmenu()},this.handleFocusOut=o=>{o.relatedTarget&&o.relatedTarget instanceof Element&&this.host.contains(o.relatedTarget)||this.disableSubmenu()},this.handlePopupMouseover=o=>{o.stopPropagation()},this.handlePopupReposition=()=>{const o=this.host.renderRoot.querySelector("slot[name='submenu']"),s=o==null?void 0:o.assignedElements({flatten:!0}).filter(v=>v.localName==="sl-menu")[0],i=getComputedStyle(this.host).direction==="rtl";if(!s)return;const{left:a,top:u,width:d,height:b}=s.getBoundingClientRect();this.host.style.setProperty("--safe-triangle-submenu-start-x",`${i?a+d:a}px`),this.host.style.setProperty("--safe-triangle-submenu-start-y",`${u}px`),this.host.style.setProperty("--safe-triangle-submenu-end-x",`${i?a+d:a}px`),this.host.style.setProperty("--safe-triangle-submenu-end-y",`${u+b}px`)},(this.host=t).addController(this),this.hasSlotController=e}hostConnected(){this.hasSlotController.test("submenu")&&!this.host.disabled&&this.addListeners()}hostDisconnected(){this.removeListeners()}hostUpdated(){this.hasSlotController.test("submenu")&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners()}addListeners(){this.isConnected||(this.host.addEventListener("mousemove",this.handleMouseMove),this.host.addEventListener("mouseover",this.handleMouseOver),this.host.addEventListener("keydown",this.handleKeyDown),this.host.addEventListener("click",this.handleClick),this.host.addEventListener("focusout",this.handleFocusOut),this.isConnected=!0),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.addEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=!0)}removeListeners(){this.isConnected&&(this.host.removeEventListener("mousemove",this.handleMouseMove),this.host.removeEventListener("mouseover",this.handleMouseOver),this.host.removeEventListener("keydown",this.handleKeyDown),this.host.removeEventListener("click",this.handleClick),this.host.removeEventListener("focusout",this.handleFocusOut),this.isConnected=!1),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.removeEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=!1)}handleSubmenuEntry(t){const e=this.host.renderRoot.querySelector("slot[name='submenu']");if(!e){console.error("Cannot activate a submenu if no corresponding menuitem can be found.",this);return}let o=null;for(const s of e.assignedElements())if(o=s.querySelectorAll("sl-menu-item, [role^='menuitem']"),o.length!==0)break;if(!(!o||o.length===0)){o[0].setAttribute("tabindex","0");for(let s=1;s!==o.length;++s)o[s].setAttribute("tabindex","-1");this.popupRef.value&&(t.preventDefault(),t.stopPropagation(),this.popupRef.value.active?o[0]instanceof HTMLElement&&o[0].focus():(this.enableSubmenu(!1),this.host.updateComplete.then(()=>{o[0]instanceof HTMLElement&&o[0].focus()}),this.host.requestUpdate()))}}setSubmenuState(t){this.popupRef.value&&this.popupRef.value.active!==t&&(this.popupRef.value.active=t,this.host.requestUpdate())}enableSubmenu(t=!0){t?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(!0)},this.submenuOpenDelay)):this.setSubmenuState(!0)}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(!1)}updateSkidding(){var t;if(!((t=this.host.parentElement)!=null&&t.computedStyleMap))return;const e=this.host.parentElement.computedStyleMap(),s=["padding-top","border-top-width","margin-top"].reduce((i,a)=>{var u;const d=(u=e.get(a))!=null?u:new CSSUnitValue(0,"px"),v=(d instanceof CSSUnitValue?d:new CSSUnitValue(0,"px")).to("px");return i-v.value},0);this.skidding=s}isExpanded(){return this.popupRef.value?this.popupRef.value.active:!1}renderSubmenu(){const t=getComputedStyle(this.host).direction==="rtl";return this.isConnected?l`
    ...
    `:l` <slot name="submenu" hidden></slot> `}},Ne=g`
  :host {
    --track-width: 2px;
...
`,_t=class extends z{constructor(){super(...arguments),this.localize=new Z(this)}render(){return l`
    ...
    `}};k.styles=[A,Ie];k.dependencies={"sl-icon":yt,"sl-popup":jt,"sl-spinner":_t};n([w("slot:not([name])")],k.prototype,"defaultSlot",2);n([w(".menu-item")],k.prototype,"menuItem",2);n([r()],k.prototype,"type",2);n([r({type:Boolean,reflect:!0})],k.prototype,"checked",2);n([r()],k.prototype,"value",2);n([r({type:Boolean,reflect:!0})],k.prototype,"loading",2);n([r({type:Boolean,reflect:!0})],k.prototype,"disabled",2);n([E("checked")],k.prototype,"handleCheckedChange",1);n([E("disabled")],k.prototype,"handleDisabledChange",1);n([E("type")],k.prototype,"handleTypeChange",1);k.define("sl-menu-item");var He=g`
  :host {
    display: block;
    position: relative;
...
`,Dt=class extends z{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(t){const e=["menuitem","menuitemcheckbox"],o=t.composedPath(),s=o.find(d=>{var b;return e.includes(((b=d==null?void 0:d.getAttribute)==null?void 0:b.call(d,"role"))||"")});if(!s||o.find(d=>{var b;return((b=d==null?void 0:d.getAttribute)==null?void 0:b.call(d,"role"))==="menu"})!==this)return;const u=s;u.type==="checkbox"&&(u.checked=!u.checked),this.emit("sl-select",{detail:{item:u}})}handleKeyDown(t){if(t.key==="Enter"||t.key===" "){const e=this.getCurrentItem();t.preventDefault(),t.stopPropagation(),e==null||e.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(t.key)){const e=this.getAllItems(),o=this.getCurrentItem();let s=o?e.indexOf(o):0;e.length>0&&(t.preventDefault(),t.stopPropagation(),t.key==="ArrowDown"?s++:t.key==="ArrowUp"?s--:t.key==="Home"?s=0:t.key==="End"&&(s=e.length-1),s<0&&(s=e.length-1),s>e.length-1&&(s=0),this.setCurrentItem(e[s]),e[s].focus())}}handleMouseDown(t){const e=t.target;this.isMenuItem(e)&&this.setCurrentItem(e)}handleSlotChange(){const t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0])}isMenuItem(t){var e;return t.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((e=t.getAttribute("role"))!=null?e:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(o=>{o.setAttribute("tabindex",o===t?"0":"-1")})}render(){return l`
      ...
      ></slot>
    `}};Dt.styles=[A,He];n([w("slot")],Dt.prototype,"defaultSlot",2);Dt.define("sl-menu");var Ke=g`
  :host {
    display: block;
  }
...
`,We=(t="value")=>(e,o)=>{const s=e.constructor,i=s.prototype.attributeChangedCallback;s.prototype.attributeChangedCallback=function(a,u,d){var b;const v=s.getPropertyOptions(t),B=typeof v.attribute=="string"?v.attribute:t;if(a===B){const C=v.converter||Ot,U=(typeof C=="function"?C:(b=C==null?void 0:C.fromAttribute)!=null?b:Ot.fromAttribute)(d,v.type);this[t]!==U&&(this[o]=U)}i.call(this,a,u,d)}},je=g`
				...
				`;case"completed":{let s=o.value;const i=[].concat(...this.excludedUsers.map(a=>a.map(u=>u.toString())));return s=s.filter(a=>!a.agents.find(u=>i.includes(u.toString()))),s.length===0?l`<sl-menu-item disabled>
					...
					${s.map((a,u)=>{var d;return l`
							<sl-menu-item .value=${u}>
								...
								></agent-avatar>
								${(d=a.profile)===null||d===void 0?void 0:d.name}
							</sl-menu-item>
						`})}
				`}}}render(){return l`
			<sl-dropdown
...
`,p=class extends z{constructor(){super(...arguments),this.formControlController=new se(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new wt(this,"[default]","prefix","suffix"),this.localize=new Z(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Lt}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(t){this.isButton()&&(this.button.setCustomValidity(t),this.formControlController.updateValidity())}render(){const t=this.isLink(),e=t?Mt`a`:Mt`button`;return kt`
    ...
    `}};p.styles=[A,Ge];p.dependencies={"sl-icon":yt,"sl-spinner":_t};n([w(".button")],p.prototype,"button",2);n([T()],p.prototype,"hasFocus",2);n([T()],p.prototype,"invalid",2);n([r()],p.prototype,"title",2);n([r({reflect:!0})],p.prototype,"variant",2);n([r({reflect:!0})],p.prototype,"size",2);n([r({type:Boolean,reflect:!0})],p.prototype,"caret",2);n([r({type:Boolean,reflect:!0})],p.prototype,"disabled",2);n([r({type:Boolean,reflect:!0})],p.prototype,"loading",2);n([r({type:Boolean,reflect:!0})],p.prototype,"outline",2);n([r({type:Boolean,reflect:!0})],p.prototype,"pill",2);n([r({type:Boolean,reflect:!0})],p.prototype,"circle",2);n([r()],p.prototype,"type",2);n([r()],p.prototype,"name",2);n([r()],p.prototype,"value",2);n([r()],p.prototype,"href",2);n([r()],p.prototype,"target",2);n([r()],p.prototype,"rel",2);n([r()],p.prototype,"download",2);n([r()],p.prototype,"form",2);n([r({attribute:"formaction"})],p.prototype,"formAction",2);n([r({attribute:"formenctype"})],p.prototype,"formEnctype",2);n([r({attribute:"formmethod"})],p.prototype,"formMethod",2);n([r({attribute:"formnovalidate",type:Boolean})],p.prototype,"formNoValidate",2);n([r({attribute:"formtarget"})],p.prototype,"formTarget",2);n([E("disabled",{waitUntilFirstUpdate:!0})],p.prototype,"handleDisabledChange",1);p.define("sl-button");function*Rt(t=document.activeElement){t!=null&&(yield t,"shadowRoot"in t&&t.shadowRoot&&t.shadowRoot.mode!=="closed"&&(yield*he(Rt(t.shadowRoot.activeElement))))}function Xe(){return[...Rt()].pop()}var it=[],Qe=class{constructor(t){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=e=>{var o;if(e.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const s=Xe();if(this.previousFocus=s,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;e.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const i=At(this.element);let a=i.findIndex(d=>d===s);this.previousFocus=this.currentFocus;const u=this.tabDirection==="forward"?1:-1;for(;;){a+u>=i.length?a=0:a+u<0?a=i.length-1:a+=u,this.previousFocus=this.currentFocus;const d=i[a];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||d&&this.possiblyHasTabbableChildren(d))return;e.preventDefault(),this.currentFocus=d,(o=this.currentFocus)==null||o.focus({preventScroll:!1});const b=[...Rt()];if(b.includes(this.currentFocus)||!b.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=t,this.elementsWithTabbableControls=["iframe"]}activate(){it.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){it=it.filter(t=>t!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return it[it.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const t=At(this.element);if(!this.element.matches(":focus-within")){const e=t[0],o=t[t.length-1],s=this.tabDirection==="forward"?e:o;typeof(s==null?void 0:s.focus)=="function"&&(this.currentFocus=s,s.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(t){return this.elementsWithTabbableControls.includes(t.tagName.toLowerCase())||t.hasAttribute("controls")}},Tt=new Set;function Ze(){const t=document.documentElement.clientWidth;return Math.abs(window.innerWidth-t)}function Je(){const t=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(t)||!t?0:t}function qt(t){if(Tt.add(t),!document.documentElement.classList.contains("sl-scroll-lock")){const e=Ze()+Je();let o=getComputedStyle(document.documentElement).scrollbarGutter;(!o||o==="auto")&&(o="stable"),e<2&&(o=""),document.documentElement.style.setProperty("--sl-scroll-lock-gutter",o),document.documentElement.classList.add("sl-scroll-lock"),document.documentElement.style.setProperty("--sl-scroll-lock-size",`${e}px`)}}function Ht(t){Tt.delete(t),Tt.size===0&&(document.documentElement.classList.remove("sl-scroll-lock"),document.documentElement.style.removeProperty("--sl-scroll-lock-size"))}var to=g`
  :host {
    --width: 31rem;
...
`,F=class extends z{constructor(){super(...arguments),this.hasSlotController=new wt(this,"footer"),this.localize=new Z(this),this.modal=new Qe(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=t=>{t.key==="Escape"&&this.modal.isActive()&&this.open&&(t.stopPropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),qt(this))}disconnectedCallback(){var t;super.disconnectedCallback(),this.modal.deactivate(),Ht(this),(t=this.closeWatcher)==null||t.destroy()}requestClose(t){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const o=q(this,"dialog.denyClose",{dir:this.localize.dir()});H(this.panel,o.keyframes,o.options);return}this.hide()}addOpenListeners(){var t;"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var t;(t=this.closeWatcher)==null||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),qt(this);const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([X(this.dialog),X(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});const e=q(this,"dialog.show",{dir:this.localize.dir()}),o=q(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([H(this.panel,e.keyframes,e.options),H(this.overlay,o.keyframes,o.options)]),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([X(this.dialog),X(this.overlay)]);const t=q(this,"dialog.hide",{dir:this.localize.dir()}),e=q(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([H(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),H(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Ht(this);const o=this.originalTrigger;typeof(o==null?void 0:o.focus)=="function"&&setTimeout(()=>o.focus()),this.emit("sl-after-hide")}}async show(){if(!this.open)return this.open=!0,bt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,bt(this,"sl-after-hide")}render(){return l`
      <div
        part="base"
    ...
    `}};F.styles=[A,to];F.dependencies={"sl-icon-button":Wt};n([w(".dialog")],F.prototype,"dialog",2);n([w(".dialog__panel")],F.prototype,"panel",2);n([w(".dialog__overlay")],F.prototype,"overlay",2);n([r({type:Boolean,reflect:!0})],F.prototype,"open",2);n([r({reflect:!0})],F.prototype,"label",2);n([r({attribute:"no-header",type:Boolean,reflect:!0})],F.prototype,"noHeader",2);n([E("open",{waitUntilFirstUpdate:!0})],F.prototype,"handleOpenChange",1);Y("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});Y("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});Y("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});Y("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});Y("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});F.define("sl-dialog");var eo=g`
  :host {
...
`,xt=class extends z{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};xt.styles=[A,eo];n([r({type:Boolean,reflect:!0})],xt.prototype,"vertical",2);n([E("vertical")],xt.prototype,"handleVerticalChange",1);xt.define("sl-divider");_t.define("sl-spinner");var oo=Object.defineProperty,so=Object.getOwnPropertyDescriptor,tt=(t,e,o,s)=>{for(var i=s>1?void 0:s?so(e,o):e,a=t.length-1,u;a>=0;a--)(u=t[a])&&(i=(s?u(e,o,i):u(i))||i);return s&&i&&oo(e,o,i),i};let V=class extends G(M){constructor(){super(...arguments),this.committing=!1,this.removingRole=!1}async addMembersToRole(t,e){try{this.committing=!0;const o=e.map(s=>s[0]);await this.store.client.assignRole(t,o),this.dispatchEvent(new CustomEvent("role-assigned-to-members",{composed:!0,bubbles:!0,detail:{role:t,assignees:o}})),this.shadowRoot.getElementById(`add-members-${t}`).hide()}catch(o){console.error(o),Bt(m("Error adding members to the role"))}this.committing=!1}async removeRole(t,e,o){try{this.removingRole=!0,await this.store.client.requestUnassignRole(t,o),this.dispatchEvent(new CustomEvent("unassig-role-requested",{composed:!0,bubbles:!0,detail:{role:t,assignee:e}})),this.shadowRoot.getElementById(`remove-role-${t}-for-${N(e)}`).hide()}catch(s){console.error(s),Bt(m("Error removing the role"))}this.removingRole=!1}name(t){var o;const e=this.profilesProvider.currentProfileForAgent.get(t).get();if(e.status==="completed")return(o=e.value)==null?void 0:o.name}renderRemoveRoleAction(t,e,o){const s=this.store.pendingUnassignments.get();switch(s.status){case"pending":return l`<sl-skeleton></sl-skeleton>`;case"error":return l`<display-error
				...
				></display-error>`;case"completed":return s.value.find(a=>N(a.target)===N(e.create_link_hash)&&be(a.tag).role===t.role)?l`<sl-tag>${m("Remove Role Requested")}</sl-tag>`:l`
					...
					>
						<div class="column" style="gap: 12px">
							<span
								>${m(Vt`Are you sure you want to request ${this.name(ht(e.target,pt.AGENT))} to remove its ${t.singular_name} role?`)}</span
							>
							<span
						...
						<sl-button
							...
							@click=${()=>{this.removeRole(t.role,ht(e.target,pt.AGENT),e.create_link_hash)}}
			...
			>
				<search-users
					.excludedUsers=${e.map(a=>ht(a.target,pt.AGENT))}
			...
			<div class="column" style="flex: 1">
				...
				<div class="column" style="gap: 12px; margin-top: 24px;">
					${e.length===0?l`
							...
							`:e.map(a=>l`
									<div class="row" style="align-items: center;">
										<profile-list-item
											.agentPubKey=${ht(a.target,pt.AGENT)}
										></profile-list-item>
			...
			</div>`}assigneesForRoleAndIAmAdmin(){const t=this.store.assigneesForRoleLinks.get(this.role).get(),e=this.store.myRoles.get();if(t.status!=="completed")return t;if(e.status!=="completed")return e;const o=e.value.includes(ct.role);return{status:"completed",value:{assignees:t.value,iAmAdmin:o}}}render(){const t=this.assigneesForRoleAndIAmAdmin();switch(t.status){case"pending":return l`<div
				...
				>
					...
					.error=${t.error}
				></display-error>`;case"completed":const e=this.role===ct.role?ct:this.store.config.roles_config.find(o=>o.role===this.role);return this.renderRole(e,t.value.assignees,t.value.iAmAdmin)}}};V.styles=[K,g`
			sl-divider {
				--spacing: var(--sl-spacing-small);
			}
		`];tt([r()],V.prototype,"role",2);tt([W({context:ge,subscribe:!0}),r()],V.prototype,"store",2);tt([T()],V.prototype,"committing",2);tt([T()],V.prototype,"removingRole",2);tt([W({context:J,subscribe:!0}),r()],V.prototype,"profilesProvider",2);V=tt([j(),O("manage-role-assignees")],V);export{V as ManageRoleAssignees};
